...
<section class="job_section padding-top90">
    <div class="container">
        ...
        <p class="col-md-7" style="color: #252525;">
            Jelajahi Berita dan Kabar Terbaru Ispat Indo Secara Detail.
        </p>
    </div>
</section>
                                ...
                                <div class="card" style="margin: 5px; background: #f7f7f7;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">{{ substr(strip_tags($new->description), 0, 120) }}
                                            ...
                                            <a href="{{ route('detailnews_indo', $new->link) }}"
                                    ...
                                    <div class="card-footer bg-transparent ">
                                        ...
                                        <small class="text-muted warp-right">By <a
                                                href= "{{ route('detailnews_indo', $new->link) }}">{{ $new->penulist }}</a></small>
                                    </div>
                                </div>
                            </div>
                        @endforeach
